...
before packages are loaded."
  ...
  (if curr-file
      (let (( curr-file-abs (file-truename curr-file)))
        (org-babel-load-file (concat (file-name-directory curr-file-abs) "config.org")))
    (org-babel-load-file "~/dot/config.org")))
